...
• 001_create_users: Cria a tabela de usuários para permitir o registro e controle de perfis.

• 002_create_artists: Estrutura as tabelas de artistas e álbuns com seus relacionamentos de chave estrangeira.

• 003_create_tracks: Instancia a tabela de músicas vinculada aos álbuns e artistas correspondentes.

• 004_create_playlists_and_relations: Define as tabelas de playlists e a tabela intermediária playlist_tracks.
...
6. Você está usando algum framework para escrever os endpoints da sua API? Se sim, qual?
